...
export class AddNewJobComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.addNewJobForm = new FormGroup({
      ...
      'departmentId': new FormControl(this.departments[0].Id, Validators.required),
      'jobFunctionId': new FormControl(this.jobFunctions[0].Id),
      'jobTypeId': new FormControl(this.jobTypes[0].Id),
      'positions': new FormControl(3, [Validators.required, Validators.min(0)]),
      'closingDate': new FormControl(new Date(moment().add(30, 'days').toLocaleString())),
      'experienceStarts': new FormControl(2, Validators.min(0)),
      'experienceEnds': new FormControl(3, Validators.min(0)),
      'salaryStarts': new FormControl(40000, Validators.min(0)),
      'salaryEnds': new FormControl(65000, Validators.min(0)),
